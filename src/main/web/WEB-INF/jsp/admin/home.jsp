                ...
                <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs">${pageContext.session.getAttribute("user")}</span>
                            </a>
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="${pageContext.request.contextPath}/admin/admin_user_change_password" class="btn btn-default btn-flat">修改密码</a>
                                    </div>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    <p>${pageContext.session.getAttribute("user")}</p>
                    <!-- Status -->
            ...
            <ul class="sidebar-menu" data-widget="tree">
                <li class="header">管理项目</li>
                <!-- Optionally, you can add icons to the links -->
                <%--<li class="active"><a href="#"><i class="fa fa-link"></i> <span>栏目管理页面</span></a></li>--%>
                <li><a href="#"><i class="fa fa-link"></i> <span>栏目管理页面</span></a></li>
